"""Team-era Q-learning agent for TeamRoadmapEnv (moved from q_agent.py).

q_agent.py was restored to the 1v1 SimpleForagingEnv thesis version; this
file preserves the team pipeline (train_team_exploration.py --qnet_arch
cnn and the team tests) unchanged.
"""
